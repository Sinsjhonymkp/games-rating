...
const parseBody = require("../appModules/http-utilts/parse-body");
const { config, createRating, updateRating } = require("../appModules/raiting");
...
async function voteRouteController(req, res) {
    if (req.method !== "POST") {
        ...
        try {
            ...
            await fs.writeFile(config.PATH_TO_RAITING_FILE, JSON.stringify(newRating));
